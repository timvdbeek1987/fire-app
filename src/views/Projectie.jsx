...
// ── Benodigde-inleg berekening (Tab 4) ──────────────────────────────────────
// Zelfde functie als voorheen in Planner.jsx — verbatim verplaatst, geen logica gewijzigd.
// Baseline (voor verhuizing): vereistInleg(100000, 1000000, 20, 0.097) → 6557,29/jr → €547/mnd
      ...
      {tabIndex === 4 && (() => {
        ...
        return (
          <div className="card">
            ...
            <div style={{ padding: '0.75rem 1rem', borderRadius: 'var(--r)', background: 'var(--surface-2)', border: '1px solid var(--border)', fontFamily: 'var(--font-mono)', fontSize: '0.7rem', color: 'var(--text-3)', lineHeight: 1.7 }}>
              Analytische schatting · geen inflatie · geen Monte Carlo · rendement {(r * 100).toFixed(1)}%. Zie de andere tabs voor Monte Carlo-projecties.
            </div>
          </div>
        );
      })()}
